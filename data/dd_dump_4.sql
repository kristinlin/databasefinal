...
INSERT INTO `review` VALUES (2,6,9.0,'Professor Hescat usually went through basic examples so that we would understand the concepts but the homework problems were more difficult and complex. I feel in the videos we should have done some more difficult problems as well as the basic ones.',0,2,1,10,NULL),(5,4,7.7,'More difficult that I expected, but I learned a lot. Prof clearly has a very deep understanding of the course content. He was also really active on office hours and Piazza.',0,8,4,1,9),(7,8,8.4,'Super sick dude',0,7,8,9,NULL),(8,11,5.5,'',1,NULL,NULL,NULL,NULL),(9,10,5.5,'',0,NULL,NULL,NULL,NULL),(10,12,5.5,'',0,NULL,NULL,NULL,NULL);
...
INSERT INTO `student_likes_review` VALUES (3,2,8);
...
-- Dump completed on 2021-12-08 20:41:42
