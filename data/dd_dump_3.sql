CREATE DATABASE  IF NOT EXISTS `das_a_link_dd` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
USE `das_a_link_dd`;
...
INSERT INTO `review` VALUES (2,6,5.5,'boop',0,1,2,NULL,5),(5,4,8.5,'boopity boop bop',0,4,2,4,1),(6,5,5.0,'sk;vkj;',0,7,NULL,NULL,NULL),(7,8,8.4,'Super sick dude',0,7,8,9,NULL),(8,11,5.5,'',0,NULL,NULL,NULL,NULL),(9,10,5.5,'',0,NULL,NULL,NULL,NULL),(10,12,5.5,'',0,NULL,NULL,NULL,NULL);
...
-- Dump completed on 2021-12-08 19:08:32
